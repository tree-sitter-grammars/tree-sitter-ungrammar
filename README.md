...
Adapted from the official spec documented at the top of this [grammar file](https://github.com/rust-analyzer/ungrammar/blob/master/rust.ungram)

[ci]: https://img.shields.io/github/actions/workflow/status/tree-sitter-grammars/tree-sitter-ungrammar/ci.yml?logo=github&label=CI
