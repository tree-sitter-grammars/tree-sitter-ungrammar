...
//! let language = tree_sitter_ungrammar::LANGUAGE;
//! parser
//!     .set_language(&language.into())
//!     .expect("Error loading ungrammar parser");
...
extern "C" {
    fn tree_sitter_ungrammar() -> *const ();
}

/// The tree-sitter [`LanguageFn`] for this grammar.
pub const LANGUAGE: LanguageFn = unsafe { LanguageFn::from_raw(tree_sitter_ungrammar) };
